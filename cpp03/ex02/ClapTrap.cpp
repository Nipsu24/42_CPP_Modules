...
/*   Updated: 2024/12/11 16:00:43 by mmeier           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::takeDamage(unsigned int amount)
{
	...
	else if (typeid(*this) == typeid(ScavTrap))
		std::cout << "ScavTrap " << mName << " gets hit and takes " << amount << " amount of damage!" << std::endl;
	else if (typeid(*this) == typeid(FragTrap))
		std::cout << "FragTrap " << mName << " gets hit and takes " << amount << " amount of damage!" << std::endl;
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	if (mEnergyPoints > 0 && mHitPoints > 0)
	{
		...
		if (typeid(*this) == typeid(ClapTrap))
			...
			std::cout << "FragTrap " << mName << " repairs itself and gets " << amount << " hit points back!" << std::endl;
	...
	else if (mEnergyPoints <= 0)
	{
		if (typeid(*this) == typeid(ClapTrap))
			...
			std::cout << "FragTrap " << mName << " cannot repair as it does not have any energy points left!" << std::endl;
	}
	else if (mHitPoints <= 0)
	{
		if (typeid(*this) == typeid(ClapTrap))
